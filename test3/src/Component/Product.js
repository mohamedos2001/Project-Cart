        ...
        return(
            <>
                ...
                <div className="col-md-6">
                    ...
                    <button className="btn btn-outline-dark px-4 py-2"onClick={()=>dispatch(AddToCart(product))}>Add To Cart</button>
                    <Link to={'/cart'} className="btn btn-dark ms-2 px-3 py-2">Go To Cart</Link>
                    <Link to={'/products'} className="btn btn-outline-dark ms-2 px-3 py-2">Back To Products</Link>
                </div>
            </>
        )
    }
